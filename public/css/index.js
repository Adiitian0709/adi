...
//   document.querySelector(".button5").classList.toggle("darkmode");
//   document.querySelector(".button6").classList.toggle("darkmode");
//   document.querySelector(".button7").classList.toggle("darkmode");
//   document.querySelector(".button8").classList.toggle("darkmode");
//   document.querySelector(".mainbar").classList.toggle("darkmode");
//   document.querySelector(".topbar").classList.toggle("darkmode");
//   document.querySelector(".rightbar").classList.toggle("darkmode");
//   document.querySelector(".sidebar").classList.toggle("darkmode");
//   document.querySelector(".maindiv").classList.toggle("darkmode");
// }
